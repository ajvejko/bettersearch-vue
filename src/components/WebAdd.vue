<script setup></script>
<template>
<div class="z-2 absolute top-0 flex h-screen w-screen items-center justify-center bg-black/50">
      <div class="relative w-1/4 rounded-xl border-2 bg-neutral-900 p-4 text-center">
        <button
          class="py-0.25 absolute right-0 top-0 px-2 text-lg text-white hover:text-red-500"
        >
          X
        </button>
        <div class="text-center font-bebas text-3xl text-white">
          Add Website
        </div>
